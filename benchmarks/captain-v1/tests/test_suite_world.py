...
class SuiteWorldTests(unittest.TestCase):
    ...
    def test_dispatch_completes_and_releases_worker_only_when_due(self):
        s=world.make_state();s,r=world.step(s,{'op':'dispatch','task':'T-C','worker':'green','book':'/bench/task','branch':'feat/c','idempotency_key':'T-C'})
    ...
    def test_virtual_file_does_not_open_host_path(self):
        ...
        self.assertFalse(r['ok']);self.assertEqual(s['files'],{})
